...
from networksecurity.utils.common import load_numpy_array_data, evaluate_models, save_object, load_object
...
import dagshub
dagshub.init(repo_owner='soishi570', repo_name='NetworkSecurity-DataScienceProject', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric, model_name):
        mlflow.set_registry_uri("https://dagshub.com/soishi570/NetworkSecurity-DataScienceProject.mlflow")  
    ...
    def train_model(self, X_train, y_train, x_test, y_test):
        ...
        self.track_mlflow(best_model, classification_train_metrics, model_name)

        #  testing part
        y_test_pred = best_model.predict(x_test)
        classification_test_metrics = get_classification_score(y_true=y_test, y_pred=y_test_pred)
        self.track_mlflow(best_model, classification_test_metrics, model_name)
